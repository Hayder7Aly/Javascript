...
let {Django,Python, ...React} = Developer;
console.log(Django)
console.log(Python)
console.log(React)
...
// it is used for when we want concate the first array to second array then we can use spread operator it is considered a dry rule in js and most use in REACT JS  . 
...
// console.log(colors.concat('yellow' , 'color'))
