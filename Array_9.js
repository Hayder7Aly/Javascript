...
//push element at the start of array 👍
// marks.unshift(1)
// console.log(marks)
...
// deleting elements with starting and ending point splice(from , to)
...
// arrat every function 
const array =  [11,12,18,28,19]
if(array.every((age) => age>=10)){
    console.log('Yes, all the candidate team is eleigible to work')
}
else{
    console.log('No , this is not eligible to work .')
}

const myArriy = [10,20,30,40,50]
const reducer = myArriy.reduce((accum,num)=>{
   debugger;
   return accum += num;
})
...
// console.log(typeof myArriy.toString())
// console.log(typeof myArriy.join())
